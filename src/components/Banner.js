...
class  Banner extends Component{
    ...
    async componentDidMount(){
        let res = await axios.get('https://api.themoviedb.org/3/trending/all/day?api_key=8071a22ab61069e095c902d8e411d789');
...
render(){
    // let movie = movies.results[ Math.floor((Math.random() * 10) + 1)];
